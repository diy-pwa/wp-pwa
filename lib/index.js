    ...
    async dev() {
        ...
        app.use('/', async (req, res) => {
            try {
                ...
                const resp = await this.getContents(data, null);
...
ini_set('error_log', $log_file);?>`);
    ...
    async getPhpInstance() {
        if (!this.php) {
            ...
            this.requestHandler = new PHPRequestHandler({
                php: this.php,
            ...
            this.php.requestHandler = this.requestHandler;
    ...
    async getContents(data, sPath) {
        try {
            ...
            if (resp.httpStatusCode == 302) {
                ...
                let sNewLocation = sLocation.replace(/.*wp-admin/, "wp-admin");
    ...
    getRelativeWithPath(sContents, sOutPath) {
        ...
        return this.getRelative(sContentsWithPath, sOutPath)
    }
